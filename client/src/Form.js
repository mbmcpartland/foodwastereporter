...
class Form extends Component {
  ...
  handleSubmit(e)
  {
      ...
      var reroute = 'http://ec2-54-183-104-114.us-west-1.compute.amazonaws.com:3000/api/insert?email='+y+'&&phone='+x;

      fetch(reroute, 
      {
        accept: 'application/json',
      });
      return fetch(`http://ec2-54-183-104-114.us-west-1.compute.amazonaws.com:3000/api/books`, { 
        accept: 'application/json',
      });
  }
